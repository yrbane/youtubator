...
**Contribuer** : règles de contribution (sécurité des dépendances, testabilité des stores, frontière avec la config serveur, ADR, scan de secrets pre-commit) dans [docs/GUIDELINES.md](docs/GUIDELINES.md).
